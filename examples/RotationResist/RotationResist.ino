/* This demo shows how the Tpp can use its gyroscope to detect
...
demo.  If you try to turn the Tpp, or put it on a surface that
...
pick up the Tpp, rotate it about its X and Y axes, and then put
